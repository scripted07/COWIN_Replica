...
void covid_VACC::menu()
{
    system("cls");

    int choice;
    cout << "\n\t\t\t\t\t\t\t\t\t\t*****************************************";
    cout << "\n\t\t\t\t\t\t\t\t\t\t   *    COVID19 VACCINATION REG. ...   *\n";
    cout << "\n\t\t\t\t\t\t\t\t\t\t*****************************************";
    // MAIN MENU
    cout << "\n\n\n\t\t\t\t\t\t\t\t\t\t\t -->> MAIN MENU <<--";
    cout << "\n\n\n\t\t\t\t\t\t\t\t\t\t\t -->>1. ADMIN";
    ...
    case 3:
        system("cls");
        cout << "\n\n\t\t\t COVID19 MANAGEMENT SYSTEM - BY CURAJ STUDENT'S";
        Sleep(10);
        exit(0);
    default:
...
// ADMIN LOGIN
void covid_VACC::admin_password()
{
    system("cls");
    char a_name[20];
    char a_password[20];
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name, "curaj") == 0) && (strcmp(a_password, "cu@123") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
...
void covid_VACC::valid(string str) // Check Username is available or not
{
    string dir, user;
    ifstream file;
    dir = str + ".txt";
...
void covid_VACC::add_vaccine_stock()
{
A:
    fstream file;
    system("cls");
    ...
    case 1:
    {
        ...
        int sum =0;
        sum = sum_vaccine_c1;
        cout<<"\n\n\t Previous available vaccine :"<<sum;
        ...
        cout << "\n\n\nPress Any Key To Continue..";
        getch();
        cout<<"\n\n Total available vaccine :"<<sum_vaccine_c1;
        goto A;
        break;
    }
    case 2:
    {
        ...
        cout << "\n\n\nPress Any Key To Continue..";
        getch();
        cout<<"\n\n Total available vaccine :"<<sum_vaccine_c2 ;
        goto A;
        break;
    }
    case 3:
    {
        ...
        cout<<"\n\n\t Total available vaccine :"<<sum_vaccine_c3;
...
void covid_VACC::display_vaccine_stock()
{
    system("cls");
    ifstream ind;
    ...
    ind.seekg(0, ios::beg);
    while (ind.read((char *)this, sizeof(covid_VACC)))
        ;
    {
        i++;
    }
    ...
    file2.close();
    file3.close();
    cout << "\n\n TOTAL VACCINATION DONE IN A DAY AT EACH CENTERS: " <<s;
    cout << "\n\nPress Any Key To Continue..";
    getch();
}

void covid_VACC::add_doctor()
{
    system("cls");
    cout << "\n\t\t\t\t\t\t\t\t\t\t*****************************************";
    cout << "\n\t\t\t\t\t\t\t\t\t\t   *    COVID19 VACCINATION REG     *";
...
B:
    ...
    file.write((char *)this, sizeof(covid_VACC));
...
void covid_VACC::display_doctor_data()
{
    system("cls");
    cout << "\n\t\t\t\t\t\t\t\t\t\t*****************************************";
    cout << "\n\t\t\t\t\t\t\t\t\t\t   *    COVID19 VACCINATION REG     *";
...
void covid_VACC::doctor_show_data()
{
...
void covid_VACC::search_doctor_data()
{
B:
    system("cls");
    int choice;
    ...
    case 1:
    {
        ...
        {
            file.read((char *)this, sizeof(covid_VACC));
        }
        while (!file.eof())
        {
...
void covid_VACC::applied_vaccine()
{
    ifstream ind;
    system("cls");
    cout << "\n\t\t\t\t\t\t\t\t\t\t*****************************************";
...
void covid_VACC::show_patient_data()
{
B:
    system("cls");
    int choice;
...
void covid_VACC::search_by_aadhar()
{
    int count = 0;
    string sadhaar;
    ifstream file;
...
void covid_VACC::search_by_profession()
{
    int count = 0;
    string sprofession;
    ifstream file;
...
void covid_VACC::search_by_gender()
{
    int count = 0;
    char sgender[10];
    ifstream file;
...
void covid_VACC::add_patient_data()
{
    fstream file;
    system("cls");
    cout << "\n\t\t\t\t\t\t\t\t\t\t*****************************************";
...
B:
    ...
    file.write((char *)this, sizeof(covid_VACC));
    cout << "\n\nYOU ARE SUCCESSFULY REGISTERD FOR 1ST DOSE:)";
    cout << "\n\nPress Any Key To Continue..";
    file.close();
    getch();
...
void covid_VACC::patient_show_data()
{
    int count = 0;
    string vadhaar;
    ifstream file;
...
void covid_VACC::update_patient_data()
{
    fstream file;
    system("cls");
    string maadhaar;
    ...
    while (!file.eof())
    {
        if (maadhaar.compare(adhaar) == 0)
        {
            ...
            cout << "\n\n ENTER YOUR CENTER CHOICE(1/2/3)";
            cin>>cc;
             cout << "\n\nCENTER YOU CHOOSED:\t";
             cout <<cc;
            cout << "\n\nYou are successfuly registerd for 2nd dose:)";
        }
        file.read((char *)this, sizeof(*this));
    }
    if (count == 0)
